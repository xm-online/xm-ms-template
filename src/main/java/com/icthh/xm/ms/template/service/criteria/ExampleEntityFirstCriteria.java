...
/**
 * Criteria class for the {@link com.icthh.xm.ms.template.domain.ExampleEntityFirst} entity. This class is used
 * in {@link com.icthh.xm.ms.template.web.rest.ExampleEntityFirstResource} to receive all the possible filtering options from
...
public class ExampleEntityFirstCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, exampleEntitySecondId, distinct);
    }
